...
if __name__ == '__main__':
    ...
    parser.add_argument('--batch_size', type=int, default=32, help='label dimension')
    parser.add_argument('--gpu', type=str, default='0', help='label dimension')
    ...
    parser.add_argument('--model_path', type=str, default=None, help='datasets path')
    parser.add_argument('--image_path', type=str, default='datasets/generation', help='datasets path')
